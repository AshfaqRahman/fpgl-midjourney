...
//        imageView.setImageBitmap(bitmap);
            ...
            holder.left_chat_image_view.setImageBitmap(message.getBitmap());
        }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        ImageView left_chat_image_view;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            left_chat_image_view = itemView.findViewById(R.id.left_chat_image_view);
